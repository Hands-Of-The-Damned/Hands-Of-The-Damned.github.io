...
<html lang="en-US">
	...
	<title>Log In &lsaquo; Hands of the Damned &#8212; WordPress</title>
		...
		<form name="loginform" id="loginform" action="http://localhost:8000/wp-login.php" method="post">
			...
			<p class="submit">
				<input type="submit" name="wp-submit" id="wp-submit" class="button button-primary button-large" value="Log In">
									<input type="hidden" name="redirect_to" value="http://localhost:8000/wp-admin/">
...
if ( typeof wpOnload === 'function' ) { wpOnload() }</script>
				<p id="backtoblog">
			<a href="/">&larr; Go to Hands of the Damned</a>		</p>
			</div>
...
<script id="user-profile-js-extra">var userProfileL10n = {"user_id":"0","nonce":"55347e3245"};</script>
